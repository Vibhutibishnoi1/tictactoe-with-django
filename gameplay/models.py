#from __future__ import unicode_literals #makes all strings in this file unicode data(in python3 it doesn't have any effect)
#because in python3 all strings are unicode by default
#if you import anything from future it should be at the top 
#from django.utils.encoding import python_2_unicode_compatible #imports a decorator
...
GAME_STATUS_CHOICES = (             #variable to hold status
...
#@python_2_unicode_compatible  #decorator used to add a unicode method to our model aytomatically in python2 
class Game(models.Model):
    first_player=models.ForeignKey(User, related_name="games_first_player", on_delete=models.CASCADE) #need to check later(on_delete)
    ...
    def update_after_move(self,move):
        """Updates the status if the game, given the last move"""    
    ...
    def __str__(self):   #allows you to display your data in a user friendly way(this method is also used by the django admin to display your objects)
